...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      form.insertAdjacentElement("afterend", statusMessage); // request.setRequestHeader();
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)(".modal", modalTimerId);
  }, 300000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-02-01');
});
